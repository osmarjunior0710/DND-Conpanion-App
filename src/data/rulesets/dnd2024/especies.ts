...
export const especies: Especie[] = [
  {
    ...
    traços: [
      { nome: "Visão no Escuro", descricao: "Você tem Visão no Escuro com um alcance de 36 metros." },
  ...
  },
  {
    ...
    traços: [
      ...
      { nome: "Visão no Escuro", descricao: "Você tem Visão no Escuro com um alcance de 18 metros." },
